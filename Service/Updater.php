...
class Updater {
     ...
     */
    public function __construct(ContainerInterface $container, EntityManager $yuccaEntityManager, FormFactory $formFactory, EventDispatcher $eventDispatcher) {
     ...
     * @param $models
     */
    public function checkSecurity($form_name, $ids, $configuration, $models) {
        // Check roles
        $event = new AclCheckEvent($form_name, $ids, $configuration, $models);
        $this->eventDispatcher->dispatch(
            sprintf(
                '%s:%s',
     ...
     * @throws \InvalidArgumentException
     */
    public function getAutoGeneratedForm($form_name, array $ids) {
        ...
        //Check security
        $this->checkSecurity($form_name, $ids, $configuration, $models);
