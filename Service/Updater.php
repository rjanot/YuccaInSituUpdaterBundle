...
class Updater
{
    ...
    public function getAutoGeneratedForm($form_name, array $ids, $add=false)
    {
        ...
        //Create Form
        $formType = new AutoGeneratedFormType(
            $configuration,
            $this->securityContext,
            null
        );

        //Dispatch event to update form type (data transformers....)
        $event = new FormPreCreationEvent($formType, $configuration, $models);
        $this->eventDispatcher->dispatch(
            sprintf(
                '%s:%s',
                \Yucca\InSituUpdaterBundle\Events::onFormPreCreation,
                $form_name
            ),
            $event
        );
